...
{
    public partial class U8_SubForms : Form
    {
        public U8_SubForms()
        {
            InitializeComponent();
        ...
        */
                                    ...
                                    switch (cmd)
                                    {
                                        ...
                                        case (byte)X6Command.CMD_CARD_TEST://刷卡
                                          ...
                                          //  }
                                            ...
                                            X6GetResultObj.cardNum = Encoding.ASCII.GetString(validFrame, 17, 16).ToUpper();
        ...
        private void X6textBoxConfigPrint_TextChanged(object sender, EventArgs e)
        {
